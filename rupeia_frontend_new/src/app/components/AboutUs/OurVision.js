  ...
  return (
    <div className="relative h-[250px] sm:h-[350px] w-full sm:w-[60%] mx-auto px-4 sm:px-28">
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-opacity-40 flex-col gap-3">
        <h2 className="text-white text-[30px] sm:text-[35px] md:text-[50px] font-bold text-center px-4 uppercase">
          Our Vision
        </h2>
        <p className="text-white text-[13px] sm:text-[24px] px-8 sm:px-36 text-center">
