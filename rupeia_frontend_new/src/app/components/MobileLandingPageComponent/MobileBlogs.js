...
const MobileBlogs = () => {
  ...
  return (
    <div className="px-5 sm:px-28 flex flex-col w-full h-full">
      <div>
      ...
      <div className="sm:px-28">
        <p className="text-white  text-[25px] sm:text-[35px] text-left font-semibold">
          Our Centre of Knowledge{" "}
        </p>
      </div>
      <div className="w-full flex items-center justify-start sm:justify-center gap-10 mt-4 sm:mt-8 overflow-x-auto">
        <div className="flex gap-4 sm:gap-14 px-2">
          {dummyBlogsData?.map((data, index) => (
            <div className="border-[1px] border-[#FFFFFF] p-4 w-[300px] sm:w-[380px] flex flex-col gap-2">
              <div>
