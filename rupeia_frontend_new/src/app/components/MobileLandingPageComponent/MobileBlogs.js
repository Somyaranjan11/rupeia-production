  ...
  return (
    <div className="px-5 sm:px-28 py-16 flex flex-col w-full h-full">
      ...
      <div className="sm:px-28 mt-5">
        <p className="text-white  text-[25px] sm:text-[32px] text-left font-semibold">
      ...
      <div className="sm:px-28 flex justify-center items-center mt-20">
        <button className="uppercase bg-white h-[60px] w-[280px] flex justify-center items-center gap-2 rounded-4xl text-[14px] sm:text-[16px] text-left font-semibold border-[1px] border-[#551262] text-[#551262]">
          view all blogs
