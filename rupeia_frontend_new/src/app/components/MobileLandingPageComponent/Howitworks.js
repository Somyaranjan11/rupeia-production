...
const Howitworks = () => {
  return (
    <div className="bg-[#350040] flex flex-col gap-3 sm:gap-8 px-4 sm:px-28 py-20 font-poppins ">
      <div className="why-stress-free w-full sm:w-[85%] flex justify-center items-center p-10 flex-col gap-2 mx-auto">
        <p className="text-[#ECAFFF] text-[18px] sm:text-[48px] font-semibold text-center ">
          Why Stress-Free Investing?
        </p>
        <p className="text-white text-[14px] sm:text-[32px] font-normal text-center">
          Stress-free investing means your portfolio is monitored round the
          clock 

          <p className="text-white text-[14px] sm:text-[32px] font-normal text-center">just like having your personal CA, so your goals stay on track</p>
          <p className="text-white text-[14px] sm:text-[32px] font-normal text-center">and you can concentrate your job.</p>
        </p>
      </div>
      <div>
        <span className="pb-2 sm:py-10 text-[28px] sm:text-[85px] font-medium -tracking-wide text-white flex-wrap text-center flex justify-center items-center gap-4">
          <span>Built</span>
          <span className="text-[#E760D5]">for 5 crore</span>
          <span>proud employees!</span>
        </span>
        <p className="text-[32px] sm:text-[80px] font-normal text-white text-left pl-20">
          How it works?
        </p>
      ...
      <div className="flex flex-row gap-3 sm:gap-10 justify-start sm:justify-center items-center overflow-x-auto">
        <div className=" border-[2px] border-[#FFFFFF61] min-w-[250px] sm:min-w-0 sm:w-fit rounded-3xl p-8 sm:mt-5 flex flex-col gap-5 h-[269px]">
          <span className="text-[20px] sm:text-[32px] font-normal text-white flex flex-wrap gap-[2px]">
            <span> Smart</span>
            <span className="text-[#AF7BB6] px-1">Analysis &</span>
            <span>Fund Allocation</span>
          </span>
          <p className="text-[14px] sm:text-[20px] font-normal text-white text-left">
      ...
      <div className="px-2 flex flex-col gap-5">
        <p className="text-[24px] sm:text-[64px] font-semibold font-poppins text-center text-[#ECE6ED] tracking-wide">
          Sit back, relax and watch your money grow.
        </p>
        <p className="text-[16px] sm:text-[48px] font-semibold leading-6 text-center font-poppins text-[#AF7BB6]">
