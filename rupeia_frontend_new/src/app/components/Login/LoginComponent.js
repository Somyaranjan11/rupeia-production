  ...
  return (
    <div className="bg-[#D9B9E2] p-5 flex flex-col gap-2 rounded-4xl">
      <div className="bg-white rounded-2xl flex justify-center items-center gap-2 py-2">
        ...
        <p className="text-[13px] font-medium leading-5 text-black">Continue with Apple</p>
      </div>
      <div className="bg-[#270330] rounded-2xl flex justify-center items-center gap-2 py-2">
        <span>
          <FcGoogle />
        </span>
        <p className="text-[13px] font-medium leading-5 text-white">Continue with Google</p>
      </div>
      <div className="bg-[#270330] rounded-2xl flex justify-center items-center gap-2 py-2">
        <span>
          <FaMicrosoft className="text-black" />
        </span>
        <p className="text-[13px] font-medium leading-5 text-white">Continue with Microsoft</p>
      </div>
      <div className="bg-[#270330] rounded-2xl flex justify-center items-center gap-2 py-2">
