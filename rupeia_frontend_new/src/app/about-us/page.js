    ...
    <div className="min-h-screen flex flex-col bg-[#350040]">
      ...
      <div className="py-10 sm:py-14 flex flex-col gap-5 px-5 sm:px-28">
        <span className="flex flex-row items-center gap-1 justify-center">
          ...
          <p className="text-[36px] sm:text-[64px] text-[#ECAFFF] text-center font-medium sm:font-semibold tracking-wide uppercase">
            us
          </p>
        </span>

        <p className="text-[16px] sm:text-[42px] text-[#ECAFFF] text-center font-semibold tracking-wide sm:px-14">
