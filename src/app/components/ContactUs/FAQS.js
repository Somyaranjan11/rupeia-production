...
const FAQS = ({ categoriesValue, setStep }) => {
  ...
  return (
    <div className="overflow-y-aut flex flex-col justify-between h-full">
      ...
      <div
        className={`grid grid-cols-1 ${loading ? "gap-0 mt-3" : "gap-4 mt-5"} `}
      >
        {loading ? (
