  ...
  return (
    <div className="px-5 sm:px-28 py-8 sm:-16 flex flex-col w-full h-full">
      ...
      <div className="sm:px-28 flex justify-center items-center mt-10 sm:mt-20">
        <button
          className="uppercase cursor-pointer bg-white h-[50px] sm:h-[60px] w-[90%] sm:w-[280px] flex justify-center items-center gap-2 rounded-4xl text-[14px] sm:text-[16px] text-left font-semibold border-[1px] border-[#551262] text-[#551262]"
          type="button"
          onClick={() => {
            router.push("/blog");
          }}
